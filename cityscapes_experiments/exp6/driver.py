...
if __name__ == '__main__':
    ...
    model = DeepLabv3(n_channels=64, n_classes=19)
    if fed_learning:
    ...
    if not only_test:
        ...
        model = test(model, dataset_dict, load_path = './saved_modelse_dice/client_'+str(int(center_num)-1)+'_best_val.pth', loss_string='dice', device=device)
    else:
