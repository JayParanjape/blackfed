...
# for j in range(len(datasets_list)):
#     server.load_state_dict(torch.load('./saved_models_server31client10_rev/tmp_server_bg.pth'))
#     # server.load_state_dict(torch.load('./safe_5/saved_models_server31client10_rev/'+str(datasets_list[j])+'/server_best_val.pth'))
#     server.eval()
...
#         # except:
#         clients[j].load_state_dict(torch.load('./saved_models_server31client10_rev/tmp_client_bg'+str(datasets_list[j]-1)+'.pth'))
#         clients[j].eval()
