...
class UNext_Server(nn.Module):

    ## Conv 3 + MLP 2 + shifted MLP
    
    def __init__(self,  num_classes, input_channels=64, deep_supervision=False,img_size=256, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
