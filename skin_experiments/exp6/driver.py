...
def test(model, dataset_dict, load_path, loss_string, device, center_num='0', vis_dir = './tmp_vis'):
    ...
    hds = []
    bs=1
    dataloader = torch.utils.data.DataLoader(dataset_dict['test'], batch_size=bs, shuffle=False, num_workers=4)
...
if __name__ == '__main__':
    ...
    model = DeepLabv3(n_channels=64, n_classes=1, use_sigmoid=True)
    if fed_learning:
